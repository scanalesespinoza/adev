...
32. Every approved and merged PR to `main` must end with operational cleanup: verify the merge, update handoff if used, and delete the source branch locally and remotely unless a documented hold condition applies.
